...
with open('device_info.csv', mode='r') as csvfile:
    ...
    for row in reader:
        ...
        switch = {'device_type': 'cisco_ios_telnet', 'ip': hostname, 'username': username, 'password': password,
        ...
        if re.search('IOS', show_version):
            ...
            show_ip_arp_txt = ssh_session.send_command('show ip arp | Proto|Incomplete')
